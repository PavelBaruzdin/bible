        ...
        <html>
            ...
            <body>
                <div class="navbar">
                    ...
                    <div class="language"><a href="godNamesByFrequency.html" style="color: #fcfcfc;">EN</a>
                    </div>
                </div>
                <h1>Trier les variantes anglaises par</h1>
                <h2><a href="godNamesFr.html">Nom</a> / <span style="color: #adada0;">Fréquence</span></h2>
                <div class="tableBox">
                    <div class="column2">
                        <table>
                            <tr>
                                <th><span style="color: ff3d64;">Fréquence<br/>(Variante Anglaise)</span></th>
                            </tr>
