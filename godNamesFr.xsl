    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <title>Noms de Dieu</title>
            </head>
            <body>
                <div class="navbar">
                    <div><a href="indexFr.html" style="color: #ffffc4;">Les Plus Fréquents</a>
                    </div>
                    <div><a href="godNamesFr.html" style="color: #ff3d64;">Noms de Dieu</a>
                    </div>
                    ...
                    <div class="language"><a href="godNames.html" style="color: #fcfcfc;">EN</a>
                    </div>
                </div>
                <h1>Trier les variantes anglaises par</h1>
                <h2><span style="color: #adada0;">Nom</span> / <a href="godNamesByFrequencyFr.html">Fréquence</a></h2>
                <div class="tableBox">
                    <div class="column2">
                        <table>
                            <tr>
                                <th>Fréquence<br/>(Variante Anglaise)</th>
                            </tr>
                            <xsl:for-each select="bible/godNames/variant">
                                <xsl:sort select="nameEn"/>
                                <tr>
                                    <td>
                    ...
                    <div class="column">
                        <table>
                            <tr>
                                <th><span style="color: ff3d64;">Variante<br/>Anglaise</span></th>
                                <th>Variante<br/>Française</th>
                            </tr>
                            <xsl:for-each select="bible/godNames/variant">
                                <xsl:sort select="nameEn"/>
                                <tr>
                    ...
                    <div class="column2">
                        <table>
                            <tr>
                                <th>Fréquence<br/>(Variante Française)</th>
                            </tr>
                            <xsl:for-each select="bible/godNames/variant">
                                <xsl:sort select="nameEn"/>
                                <tr>
